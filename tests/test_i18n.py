...
def referenced():
    ...
    for script in ('painel.js', 'atlas.js', 'login.js', 'landing.js', 'overview.js', 'panorama.js', 'panorama-charts.js',
                       'panorama-cards1.js', 'panorama-cards2.js', 'panorama-cards3.js', 'panorama-cards4.js'):
