...
'ov.eyebrow':'Energia e território','ov.title':'Visão geral dos dados','ov.lead':'Quanta energia a cadeia mineral de Goiás consome, onde e a que custo — com os filtros mudando todos os números.','ov.tag':'CCEE · BASE CONSOLIDADA',
'ov.export':'Exportar recorte ↓',
...
'ov.csvMonth':'mes','ov.csvName':'minera-goias-energia-{year}.csv',
'ov.loading':"Preparando a visão geral…",
'ov.note':"O recorte mineral são as cargas cujo CNPJ é titular de processo minerário na base do Squad 1 — não o ramo autodeclarado da CCEE, que aparece ao lado para comparação. São parcelas de carga do mercado livre, não o consumo do estado, e nenhum ano da base está completo. Preço e custo são premissa do Squad 2, detalhada na aba Preços e custo de energia.",
'ov.source':"Base consolidada do Squad 1 ({v}), pacote gerado em {d}. Energia observada da CCEE; preço e custo em premissa.",
'ov.serieMineral':"Cadeia mineral (título minerário)",'ov.serieOutras':"Outras atividades",
'ov.k.energia':"Energia da cadeia mineral",'ov.k.energiaSub':"{v}% das parcelas de carga do recorte · {m} meses",
'ov.k.emp':"Empresas com título minerário",'ov.k.empSub':"de {n} empresas com carga · {m} municípios",
'ov.k.cfem':"CFEM no mesmo recorte",'ov.k.cfemSub':"{n} recolhimentos",
'ov.k.acervo':"Arquivos no acervo",'ov.k.acervoSub':"{n} linhas importadas · atualizado em {d}",'ov.k.acervoOff':"Acervo indisponível agora",
'ov.k.custoRecorte':"Custo da energia do recorte",'ov.k.custoRecorteSub':"{m} meses de consumo observado a {p}/MWh, cenário {c}",
'ov.k.custoBase':"Custo de um ano cheio",'ov.k.custoBaseSub':"{g} GWh anualizados de {y}, ao mesmo preço",
'ov.k.custoFim':"Custo projetado em {y}",'ov.k.custoFimSub':"Demanda e preço de referência em {y}, a {p}/MWh",
'ov.h.combos':"Combinações na base",'ov.h.gwhMineral':"Cadeia mineral (GWh)",'ov.h.gwhBase':"Todas as cargas (GWh)",
'ov.csvGwhMineral':"gwh_cadeia_mineral",'ov.csvGwhBase':"gwh_todas_as_cargas",'ov.csvCut':"recorte",
'ov.c.tiles':"Energia, empresas e arrecadação no recorte",'ov.c.tiles.n':"Consumo observado das cargas com título minerário, CFEM do mesmo recorte e o tamanho do acervo importado.",
'ov.c.mes':"Consumo mês a mês",'ov.c.mes.n':"GWh das parcelas de carga, separando a cadeia mineral das demais atividades.",
'ov.c.ramo':"Cadeia mineral por ramo de atividade",'ov.c.ramo.n':"Como o consumo das cargas com título minerário se distribui entre os ramos declarados.",
'ov.c.mun':"Onde a cadeia mineral consome",'ov.c.mun.n':"Municípios com maior consumo das cargas com título minerário.",
'ov.c.emp':"Empresas com título minerário e carga",'ov.c.emp.n':"Consumo, capacidade média, fator de carga e parcela no mercado livre, por raiz de CNPJ.",
'ov.c.custo':"Quanto essa energia custa",'ov.c.custo.n':"Consumo observado avaliado ao preço de referência do módulo de preços. O detalhe, os cenários e a sensibilidade estão na aba Preços e custo de energia.",
'ov.c.cobertura':"Cobertura da fonte, ano a ano",'ov.c.cobertura.n':"O que a base cobre no recorte. Combinação é uma linha agregada da CCEE, não uma medição: a contagem de linhas de cada arquivo importado está no catálogo de fontes.",
...
'ov.eyebrow':'Energy and territory','ov.title':'Data overview','ov.lead':'How much energy the mineral chain of Goiás consumes, where, and at what cost — with the filters changing every number.','ov.tag':'CCEE · CONSOLIDATED BASE',
'ov.export':'Export this cut ↓',
...
'ov.csvMonth':'month','ov.csvName':'minera-goias-energy-{year}.csv',
'ov.loading':"Preparing the overview…",
'ov.note':"The mineral cut is the loads whose CNPJ holds a mining title in the Squad 1 base — not the self-declared CCEE sector, which is shown alongside for comparison. These are free-market load units, not the state's consumption, and no year in the base is complete. Price and cost are assumptions of Squad 2, detailed in the Energy price and cost tab.",
'ov.source':"Squad 1 consolidated base ({v}), package built on {d}. Energy observed from the CCEE; price and cost are assumptions.",
'ov.serieMineral':"Mineral chain (mining title)",'ov.serieOutras':"Other activities",
'ov.k.energia':"Energy of the mineral chain",'ov.k.energiaSub':"{v}% of the load units in the cut · {m} months",
'ov.k.emp':"Companies with a mining title",'ov.k.empSub':"of {n} companies with load · {m} municipalities",
'ov.k.cfem':"CFEM in the same cut",'ov.k.cfemSub':"{n} payments",
'ov.k.acervo':"Files in the archive",'ov.k.acervoSub':"{n} rows imported · updated on {d}",'ov.k.acervoOff':"Archive unavailable right now",
'ov.k.custoRecorte':"Cost of the energy in the cut",'ov.k.custoRecorteSub':"{m} months of observed consumption at {p}/MWh, {c} scenario",
'ov.k.custoBase':"Cost of a full year",'ov.k.custoBaseSub':"{g} GWh annualised from {y}, at the same price",
'ov.k.custoFim':"Projected cost in {y}",'ov.k.custoFimSub':"Reference demand and price in {y}, at {p}/MWh",
'ov.h.combos':"Rows in the base",'ov.h.gwhMineral':"Mineral chain (GWh)",'ov.h.gwhBase':"All loads (GWh)",
'ov.csvGwhMineral':"gwh_mineral_chain",'ov.csvGwhBase':"gwh_all_loads",'ov.csvCut':"cut",
'ov.c.tiles':"Energy, companies and royalties in the cut",'ov.c.tiles.n':"Observed consumption of loads with a mining title, CFEM of the same cut, and the size of the imported archive.",
'ov.c.mes':"Consumption month by month",'ov.c.mes.n':"GWh of the load units, separating the mineral chain from other activities.",
'ov.c.ramo':"Mineral chain by activity sector",'ov.c.ramo.n':"How the consumption of loads with a mining title spreads across the declared sectors.",
'ov.c.mun':"Where the mineral chain consumes",'ov.c.mun.n':"Municipalities with the highest consumption among loads with a mining title.",
'ov.c.emp':"Companies with a mining title and load",'ov.c.emp.n':"Consumption, average capacity, load factor and free-market share, by CNPJ root.",
'ov.c.custo':"What this energy costs",'ov.c.custo.n':"Observed consumption valued at the reference price of the price module. The detail, the scenarios and the sensitivity are in the Energy price and cost tab.",
'ov.c.cobertura':"Source coverage, year by year",'ov.c.cobertura.n':"What the base covers in the cut. A row here is an aggregated CCEE row, not a measurement: the line count of each imported file is in the source catalogue.",
