...
'preview.ccee':'CCEE','preview.mineral':'Bases minerais','preview.sheets':'Planilhas','preview.collection':'Acervo','preview.traceable':'rastreável','preview.panel':'Painel',
...
'at.tag':'ARTEFATO ELIEL · RETRATO RECEBIDO',
'at.notice':'Dados extraídos de <b>eliel.html</b>, recebido em 10/09/2026. A extração das camadas cadastrais não tem data informada. Valores e classificações estão em validação; não indicam a situação atual das barragens. O painel CCEE da visão geral consulta outra base, atualizada pelo banco.',
...
'at.footSources':'Fontes declaradas no artefato: ANM/CFEM, Anuário Mineral Brasileiro, Cadastro Mineiro, SIGBM e CCEE. Mapas convertidos da projeção e quantização originais; limites não cadastrais. Navegação e filtros adaptados do protótipo Rodrigo. Dados demonstrativos e cenários fictícios não foram importados.',
...
'at.csvSource':'Fonte','at.csvLayer':'Camada','at.csvRef':'Referência','at.thPeriod':'Período',
...
'c.sessionEnded':'Sessão encerrada.','c.failed':'Não foi possível concluir. Confira os campos.','c.checkFields':'Confira os campos informados.'
},en:{
...
'preview.ccee':'CCEE','preview.mineral':'Mineral datasets','preview.sheets':'Spreadsheets','preview.collection':'Traceable','preview.traceable':'collection','preview.panel':'Dashboard',
...
'at.tag':'ELIEL ARTEFACT · SNAPSHOT RECEIVED',
'at.notice':'Data extracted from <b>eliel.html</b>, received on 10/09/2026. The cadastral layers carry no stated extraction date. Values and classifications are still being validated; they do not report the current condition of the dams. The CCEE dashboard in the overview queries a different dataset, kept up to date by the database.',
...
'at.footSources':'Sources declared in the artefact: ANM/CFEM, Brazilian Mineral Yearbook, Mining Register, SIGBM and CCEE. Maps converted from the original projection and quantisation; boundaries are not cadastral. Navigation and filters adapted from the Rodrigo prototype. Demonstration data and fictional scenarios were not imported.',
...
'at.csvSource':'Source','at.csvLayer':'Layer','at.csvRef':'Reference','at.thPeriod':'Period',
...
'c.sessionEnded':'Session ended.','c.failed':'Could not complete the request. Check the fields.','c.checkFields':'Check the fields you entered.'
}};
function pick(){
