...
**A reconciliação com o Anuário Mineral é publicada, não resolvida.** `referencia_amb_go` traz a produção de Goiás por substância da ANM ao lado dos números das empresas. Em 2025 o Anuário registra 35.487,71 t de Ni contido no estado e a Anglo American publica 39.700 t de níquel contido em ferroníquel; 51.937,85 t de Cu contido contra 43.974 t de cobre em concentrado em Chapada; 62.626,53 t de Nb₂O₅ contido contra 10.348 t de produto de nióbio da CMOC. São medidas diferentes do mesmo negócio, e nenhuma dessas diferenças foi ajustada.
